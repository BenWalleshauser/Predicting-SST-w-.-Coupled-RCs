...
%Finds the average and maximum error for a given days forecast and returns
%plots.
...
for i = 1:nBox*mBox
    if SST_validation(1,i) ~= NaNset
        TotalArea = TotalArea+ActualAreaRectangle(i,nBox);
        area(i) = ActualAreaRectangle(i,nBox);
    end
end
